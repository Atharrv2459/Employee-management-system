...
useEffect(() => {
  const fetchEmployeeDetails = async () => {
    try {
      ...
      // Manager name not available from this endpoint as per current backend
    } catch (err) {
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="bg-white p-4 rounded-xl shadow">
          <h2 className="text-2xl font-bold text-center">
           <div className="bg-white p-4 rounded-xl shadow">
  <h2 className="text-2xl font-bold text-center">
    Employee Dashboard - {employeeName}
  </h2>
    ...
    Manager: {managerName}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            ...
            <button onClick={() => { navigate('/employee/punch') }} className="bg-red-500 text-white px-4 py-2 rounded w-full my-5">More</button>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            ...
            <div className="flex flex-col gap-4">
              ...
              <button onClick={() => navigate('/employee/leave-history')} className="bg-blue-500 text-white px-4 py-2 rounded w-full">
                Leave History
              </button>
            </div>
          </div>
